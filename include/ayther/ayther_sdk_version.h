...
#define AYTHER_SDK_VERSION_MAJOR AYTHER_VERSION_MAJOR
#define AYTHER_SDK_VERSION_MINOR AYTHER_VERSION_MINOR
#define AYTHER_SDK_VERSION_PATCH AYTHER_VERSION_PATCH

#define AYTHER_SDK_VERSION_STRING AYTHER_VERSION_STRING
